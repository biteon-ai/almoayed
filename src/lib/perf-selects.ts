...
export const QUIZ_LIST_SELECT =
  "id, title, slug, created_by, category_id, topic_id, is_active, is_free, is_archived, deleted_at, quiz_type, target_group_id, is_timed, duration_minutes, assessment_category, max_attempts, created_at, updated_at" as const;
