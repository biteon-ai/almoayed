...
export const QUIZ_LIST_SELECT =
  "id, title, created_by, category_id, topic_id, is_active, is_free, is_archived, deleted_at, quiz_type, target_group_id, is_timed, duration_minutes, created_at, updated_at" as const;
